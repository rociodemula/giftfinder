            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-justify">Necesitas registrarte o identificarte en nuestra web para ofrecer o solicitar los productos disponibles.
                        ¡Te costará solo un minuto! <a class="btn btn-xs btn-success" role="button" href="{{ url('/auth/register') }}" data-toogle="tooltip" rel="txtTooltip" data-placement="right" title="Ir a formulario de registro">Altas</a></p>
                    <p class="text-justify">Si quieres compartir algo que te sobre y no lo encuentras entre las categorías/productos disponibles,
                        ...
                        <a class="btn btn-xs btn-success" role="button" href="{{ url('/contacto') }}" data-toogle="tooltip" rel="txtTooltip" data-placement="right" title="Ir a formulario de Contacto (debes estar registrado para esto)">Contacto</a></p>
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><a href="{{ $item->link_articulo }}" target="_blank" data-toogle="tooltip" rel="txtTooltip" data-placement="bottom" title="Ver +info en Wikipedia (se abrirá en otra pestaña)">Más información</a></li>
                            </ul>
                        </div>
                        @endforeach
                        <div class="col-sm-3">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><a class="btn btn-xs btn-success" role="button" href="{{ url('/busqueda') }}" data-toogle="tooltip" rel="txtTooltip" data-placement="right" title="Ir a formulario de Busquedas (debes estar registrado para esto)">Búsqueda</a></p></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <p class="text-justify">Cualquier duda que tengas puedes transmitirla al administrador en
                        <a class="btn btn-xs btn-success" role="button" href="{{ url('/contacto') }}" data-toogle="tooltip" rel="txtTooltip" data-placement="right" title="Ir a formulario de Contacto (debes estar registrado para esto)">Contacto</a> pero asegúrate
                        de consultar antes la <a class="btn btn-xs btn-success" role="button" href="{{ url('/ayuda') }}" data-toogle="tooltip" rel="txtTooltip" data-placement="right" title="Ir a página de Ayuda">Ayuda</a></p>
                </div>
            </div>
        </div><br/><br/>
    </div>
