            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>¡Lo sentimos!</strong> No estar autorizado a visitar esta página.</h3>
                    </div>
                    <div class="panel-body">
                        <dl>
                            <dt>Es posible que:</dt>
                            <dd>- No te hayas identificado correctamente.</dd>
                            <dd>- Tu perfil de usuario no tien permisos suficientes para visitar esta parte de la aplicación.</dd>
